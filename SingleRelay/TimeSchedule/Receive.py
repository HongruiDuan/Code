...
class action:
    ...
    def custom_action(self, packet):
        ...
        if packet[0][1].dst == self.ip:  
            #将数据写入到缓存文件中
            filename = '/home/shlled/mininet-project-duan/TimeSchedule/NCLog/RU.txt'
            # filename = '/home/shlled/mininet-project-duan/TimeSchedule/NCLog/%s.txt' % packet[0][1].dst[7:8]
            f1 = open(filename, "a+")
